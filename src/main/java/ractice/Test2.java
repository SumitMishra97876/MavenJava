				...
				if (q == n) {
					if (Integer.parseInt(page) == 5) {
						...
						if (Integer.parseInt(page) == 10) {
							...
							pages = driver
									.findElement(By.xpath("//ul[@class='pagination']//li/a[text()='" + page + "']"));

							js.executeScript("arguments[0].click()", pages);
						} else {
							if (Integer.parseInt(page) != 1 && Integer.parseInt(page) != 2
									&& Integer.parseInt(page) != 3 && Integer.parseInt(page) != 4
									&& Integer.parseInt(page) != 5 && Integer.parseInt(page) != 6
									&& Integer.parseInt(page) != 7 && Integer.parseInt(page) != 8
									&& Integer.parseInt(page) != 9 && Integer.parseInt(page) != 10) {
